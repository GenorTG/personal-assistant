...
class Config:
    ...
    ENABLE_MODEL_PREWARM = os.getenv('ENABLE_MODEL_PREWARM', 'true').lower() == 'true'
    TORCH_COMPILE = os.getenv('TORCH_COMPILE', 'false').lower() == 'true'  # Experimental: can speed up inference but slow initial load
